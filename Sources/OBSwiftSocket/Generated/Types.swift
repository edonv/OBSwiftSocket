...
//  OBSwiftSocket
//
//  Generated by script on 12/22/22.
...
public enum OBSEnums {
    public struct EventSubscription: OptionSet, Codable {
        ...
        /// Subscription value to receive the ``OBSEvents/VendorEvent`` event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        ...
        /// Subscription value to receive the ``OBSEvents/InputVolumeMeters`` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        public static let inputVolumeMeters = EventSubscription(rawValue: 1 << 16)

        /// Subscription value to receive the ``OBSEvents/InputActiveStateChanged`` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        public static let inputActiveStateChanged = EventSubscription(rawValue: 1 << 17)

        /// Subscription value to receive the ``OBSEvents/InputShowStateChanged`` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        public static let inputShowStateChanged = EventSubscription(rawValue: 1 << 18)

        /// Subscription value to receive the ``OBSEvents/SceneItemTransformChanged`` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
    ...
    public enum RequestBatchExecutionType: Int, Codable {
        ...
        /// - Note: To introduce artificial delay, use the ``OBSRequests/Sleep`` request and the ``OBSRequests/Sleep/sleepMillis`` request field.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        ...
        /// - Note: To introduce artificial delay, use the ``OBSRequests/Sleep`` request and the ``OBSRequests/Sleep/sleepFrame`` request field.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case serialFrame = 1
        ...
        /// active processing, like ``OBSRequests/GetSourceScreenshot``.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case parallel = 2
    }
    ...
    public enum RequestStatus: Int, Codable {
        ...
        /// The ``OpDataTypes/Request/type`` field is missing from the request data.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
    ...
    public enum CloseCode: Int, Codable {
        ...
        /// The specified ``Message/operation`` was invalid or missing.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case unknownOp = 4006

        /// The client sent a websocket message without first sending ``OpDataTypes/Identify`` message.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case notIdentified = 4007

        /// The client sent an ``OpDataTypes/Identify`` message while already identified.
        /// - Note: Once a client has identified, only ``OpDataTypes/Reidentify`` may be used to change session parameters.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case alreadyIdentified = 4008

        /// The authentication attempt (via ``OpDataTypes/Identify``) failed.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
    ...
    public enum OpCode: Int, Codable {
        ...
        /// The message sent by a newly connected client to obs-websocket in response to a ``OpDataTypes/Hello``.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        case identify = 1
...
public enum OBSRequests {
    ...
    public struct GetPersistentData: OBSRequest {
        ...
        /// The data realm to select. ``OBSEnums/PersistentDataRealm/global`` or ``OBSEnums/PersistentDataRealm/profile``
    ...
    /// - Note: Fields must be specified in pairs. For example, you cannot set only ``OBSRequests/SetVideoSettings/baseWidth`` without needing to specify ``OBSRequests/SetVideoSettings/baseHeight``.
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    public struct GetVersion: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            /// Image formats available in ``OBSRequests/GetSourceScreenshot`` and ``OBSRequests/SaveSourceScreenshot`` requests.
    ...
    /// Broadcasts a ``OBSEvents/CustomEvent`` to all WebSocket clients. Receivers are clients which are identified and subscribed.
    /// - Complexity: `1/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    public struct CallVendorRequest: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            /// Echoed of ``OBSRequests/CallVendorRequest/vendorName``
            public var vendorName: String

            /// Echoed of ``OBSRequests/CallVendorRequest/requestType``
            public var requestType: String
    ...
    /// Triggers a hotkey using its name. See ``OBSRequests/GetHotkeyList``
    /// - Complexity: `3/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    /// Sleeps for a time duration or number of frames. Only available in request batches with types ``OBSEnums/RequestBatchExecutionType/serialRealtime`` or ``OBSEnums/RequestBatchExecutionType/serialFrame``.
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    public struct Sleep: OBSRequest {
        ...
        /// Number of milliseconds to sleep for (if ``OBSEnums/RequestBatchExecutionType/serialRealtime`` mode)
        /// - Requires: Value Restrictions - `>= 0, <= 50000`
        /// - Important: Optional Behavior - Unknown
        public var sleepMillis: Int?

        /// Number of frames to sleep for (if ``OBSEnums/RequestBatchExecutionType/serialFrame`` mode)
    ...
    /// - Note: Does not include defaults. To create the entire settings object, overlay ``OBSRequests/GetInputSettings/Response/inputSettings`` over the ``OBSRequests/GetInputDefaultSettings/Response/defaultInputSettings`` provided by ``OBSRequests/GetInputDefaultSettings``.
    /// - Complexity: `3/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    public struct SetInputVolume: OBSRequest {
        ...
        /// - Important: Optional Behavior - ``OBSRequests/SetInputVolume/inputVolumeDb`` should be specified
        public var inputVolumeMul: Int?

        /// Volume setting in dB
        /// - Requires: Value Restrictions - `>= -100, <= 26`
        /// - Important: Optional Behavior - ``OBSRequests/SetInputVolume/inputVolumeMul`` should be specified
        public var inputVolumeDb: Int?
    ...
    /// - ``OBSEnums/AudioMonitorType/none``
    /// - ``OBSEnums/AudioMonitorType/monitorOnly``
    /// - ``OBSEnums/AudioMonitorType/monitorAndOutput``
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    public struct GetInputAudioMonitorType: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            /// Audio monitor type
            public var monitorType: OBSEnums.AudioMonitorType
        }
    }
    ...
    public struct SetInputAudioMonitorType: OBSRequest {
        ...
        public init(inputName: String, monitorType: OBSEnums.AudioMonitorType) {
            self.inputName = inputName
    ...
    ///
    /// Some known ``OBSRequests/PressInputPropertiesButton/propertyName`` values are:
    ...
    ///
    /// Media States:
    /// - ``OBSEnums/MediaInputState/none``
    /// - ``OBSEnums/MediaInputState/playing``
    /// - ``OBSEnums/MediaInputState/opening``
    /// - ``OBSEnums/MediaInputState/buffering``
    /// - ``OBSEnums/MediaInputState/paused``
    /// - ``OBSEnums/MediaInputState/stopped``
    /// - ``OBSEnums/MediaInputState/ended``
    /// - ``OBSEnums/MediaInputState/error``
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    public struct GetMediaInputStatus: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            public var mediaState: OBSEnums.MediaInputState
    ...
    public struct TriggerMediaInputAction: OBSRequest {
        ...
        /// Identifier of the ``OBSEnums/MediaInputAction`` enum
    ...
    public struct DuplicateSceneItem: OBSRequest {
        ...
        /// - Important: Optional Behavior - ``OBSRequests/DuplicateSceneItem/sceneName`` is assumed
    ...
    ///
    /// Blend modes:
    /// - ``OBSEnums/BlendMode/normal``
    /// - ``OBSEnums/BlendMode/additive``
    /// - ``OBSEnums/BlendMode/subtract``
    /// - ``OBSEnums/BlendMode/screen``
    /// - ``OBSEnums/BlendMode/multiply``
    /// - ``OBSEnums/BlendMode/lighten``
    /// - ``OBSEnums/BlendMode/darken``
    ///
    /// Scenes and Groups
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    ...
    public struct GetSceneItemBlendMode: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            /// Current blend mode
            public var sceneItemBlendMode: OBSEnums.BlendMode
        }
    }
    ...
    public struct SetSceneItemBlendMode: OBSRequest {
        ...
        public init(sceneName: String, sceneItemId: Int, sceneItemBlendMode: OBSEnums.BlendMode) {
            self.sceneName = sceneName
            self.sceneItemId = sceneItemId
    ...
    ///
    /// The ``OBSRequests/GetSourceScreenshot/imageWidth`` and ``OBSRequests/GetSourceScreenshot/imageHeight`` parameters are treated as "scale to inner", meaning the smallest ratio will be used and the aspect ratio of the original resolution is kept.
    ///
    /// If ``OBSRequests/GetSourceScreenshot/imageWidth`` and ``OBSRequests/GetSourceScreenshot/imageHeight`` are not specified, the compressed image will use the full resolution of the source.
    ///
    /// **Compatible with inputs and scenes.**
    /// - Complexity: `4/5`
    /// - Version: Latest Supported RPC Version - `1`
    ...
    public struct GetSourceScreenshot: OBSRequest {
        ...
        /// Image compression format to use. Use ``OBSRequests/GetVersion`` to get compatible image formats
    ...
    ///
    /// The ``OBSRequests/SaveSourceScreenshot/imageWidth`` and ``OBSRequests/SaveSourceScreenshot/imageHeight`` parameters are treated as "scale to inner", meaning the smallest ratio will be used and the aspect ratio of the original resolution is kept.
    ///
    /// If ``OBSRequests/SaveSourceScreenshot/imageWidth`` and ``OBSRequests/SaveSourceScreenshot/imageHeight`` are not specified, the compressed image will use the full resolution of the source.
    ///
    /// **Compatible with inputs and scenes.**
    /// - Complexity: `3/5`
    /// - Version: Latest Supported RPC Version - `1`
    ...
    ///
    /// Similar to ``OBSRequests/GetInputKindList``
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    /// - Note: ``OBSRequests/GetCurrentSceneTransitionCursor/Response/transitionCursor`` will return 1.0 when the transition is inactive.
    /// - Complexity: `2/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    ///
    /// Mix types:
    /// - ``OBSEnums/VideoMixType/preview``
    /// - ``OBSEnums/VideoMixType/program``
    /// - ``OBSEnums/VideoMixType/multiview``
    ...
    public struct OpenVideoMixProjector: OBSRequest {
        ...
        /// Type of mix to open
        public var videoMixType: OBSEnums.VideoMixType

        /// Monitor index, use ``OBSRequests/GetMonitorList`` to obtain index
        /// - Important: Optional Behavior - `-1`: Opens projector in windowed mode
        public var monitorIndex: Int?

        /// Size/Position data for a windowed projector, in Qt Base64 encoded format. Mutually exclusive with ``OBSRequests/OpenVideoMixProjector/monitorIndex``
        /// - Important: Optional Behavior - N/A
        public var projectorGeometry: String?

        public init(videoMixType: OBSEnums.VideoMixType, monitorIndex: Int?, projectorGeometry: String?) {
    ...
    public struct OpenSourceProjector: OBSRequest {
        ...
        /// Size/Position data for a windowed projector, in Qt Base64 encoded format. Mutually exclusive with ``OBSRequests/OpenSourceProjector/monitorIndex``
        /// - Important: Optional Behavior - N/A
        public var projectorGeometry: String?
...
extension OBSRequests.Sleep: Encodable {
    public func encode(to encoder: Encoder) throws {
        var container = encoder.container(keyedBy: CodingKeys.self)

        try container.encodeIfPresent(sleepMillis, forKey: .sleepMillis)
        try container.encodeIfPresent(sleepFrames, forKey: .sleepFrames)
    }
}

extension OBSRequests.Sleep: Decodable {
    public init(from decoder: Decoder) throws {
        let container = try decoder.container(keyedBy: CodingKeys.self)

        self.sleepMillis = try container.decodeIfPresent(Int.self, forKey: .sleepMillis)
        self.sleepFrames = try container.decodeIfPresent(Int.self, forKey: .sleepFrames)
    }
}
...
extension OBSRequests.OpenVideoMixProjector: Decodable {
    public init(from decoder: Decoder) throws {
        ...
        self.videoMixType = try container.decode(OBSEnums.VideoMixType.self, forKey: .videoMixType)
...
public enum OBSEvents {
    ...
    /// - Note: If polling has been paused during ``OBSEvents/CurrentSceneCollectionChanging``, this is the que to restart polling.
    /// - Complexity: `1/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    public struct MediaInputActionTriggered: OBSEvent {
        ...
        /// Action performed on the input. See ``OBSEnums/MediaInputAction`` enum
        public var mediaAction: OBSEnums.MediaInputAction
    ...
    /// ``OBSEvents/SceneTransitionEnded`` only signifies the cut point, not the completion of transition playback.
    ...
    /// Applications using `Get/SaveSourceScreenshot` should implement a ``OBSEvents/CustomEvent`` if this kind of inter-client
    ...
    public struct ScreenshotSaved: OBSEvent {
        ...
        public var savedScreenshotPath: String
    ...
    /// Custom event emitted by ``OBSRequests/BroadcastCustomEvent``.
    /// - Complexity: `1/5`
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    ...
    public enum AllTypes: String, Codable {
        ...
        public static func event(ofType type: AllTypes, from eventData: JSONValue) throws -> OBSEvent? {
            ...
            case .ScreenshotSaved:
                return try eventData.toCodable(OBSEvents.ScreenshotSaved.self)
            case .VendorEvent:
                return try eventData.toCodable(OBSEvents.VendorEvent.self)
            case .CustomEvent:
                return try eventData.toCodable(OBSEvents.CustomEvent.self)
    }
        }
    }
}
