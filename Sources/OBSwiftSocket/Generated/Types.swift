...
//  OBSwiftSocket
//
//  Generated by script on 7/11/22.
...
public enum OBSRequests {
    ...
    public struct GetStats: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            public var averageFrameRenderTime: Int
    ...
    public struct SetInputAudioBalance: OBSRequest {
        ...
        public var inputAudioBalance: Double

        public init(inputName: String, inputAudioBalance: Double) {
            self.inputName = inputName
    ...
    public struct SetTBarPosition: OBSRequest {
        ...
        public init(position: Double, release: Bool?) {
