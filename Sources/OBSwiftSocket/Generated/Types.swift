...
//  OBSwiftSocket
//
//  Generated by script on 7/10/22.
...
public enum OBSEnums {
    public struct EventSubscription: OptionSet, Codable {
        ...
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let general = EventSubscription(rawValue: 1 << 0)

        /// Subscription value to receive events in the `Config` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let config = EventSubscription(rawValue: 1 << 1)

        /// Subscription value to receive events in the `Scenes` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let scenes = EventSubscription(rawValue: 1 << 2)

        /// Subscription value to receive events in the `Inputs` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let inputs = EventSubscription(rawValue: 1 << 3)

        /// Subscription value to receive events in the `Transitions` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let transitions = EventSubscription(rawValue: 1 << 4)

        /// Subscription value to receive events in the `Filters` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let filters = EventSubscription(rawValue: 1 << 5)

        /// Subscription value to receive events in the `Outputs` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let outputs = EventSubscription(rawValue: 1 << 6)

        /// Subscription value to receive events in the `SceneItems` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let sceneItems = EventSubscription(rawValue: 1 << 7)

        /// Subscription value to receive events in the `MediaInputs` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let mediaInputs = EventSubscription(rawValue: 1 << 8)

        /// Subscription value to receive the `VendorEvent` event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let vendors = EventSubscription(rawValue: 1 << 9)

        /// Subscription value to receive events in the `Ui` category.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let ui = EventSubscription(rawValue: 1 << 10)

        /// Helper to receive all non-high-volume events.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let all: EventSubscription = [.general, .config, .scenes, .inputs, .transitions, .filters, .outputs, .sceneItems, .mediaInputs, .vendors, .ui]

        /// Subscription value to receive the `InputVolumeMeters` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let inputVolumeMeters = EventSubscription(rawValue: 1 << 16)

        /// Subscription value to receive the `InputActiveStateChanged` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let inputActiveStateChanged = EventSubscription(rawValue: 1 << 17)

        /// Subscription value to receive the `InputShowStateChanged` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let inputShowStateChanged = EventSubscription(rawValue: 1 << 18)

        /// Subscription value to receive the `SceneItemTransformChanged` high-volume event.
        /// - Version: Latest Supported RPC Version - `1`
        /// - Since: Added in v5.0.0
        static let sceneItemTransformChanged = EventSubscription(rawValue: 1 << 19)
    }
...
public enum OBSRequests {
    ...
    public struct GetSceneCollectionList: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var currentSceneCollectionName: String

            /// Array of all available scene collections
            var sceneCollections: [String]
        }
    }
    ...
    public struct GetProfileParameter: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var defaultParameterValue: String?
        }
    }
    ...
    public struct GetStreamServiceSettings: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var streamServiceSettings: JSONValue
        }
    }
    ...
    public struct GetSourceFilterDefaultSettings: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var defaultFilterSettings: JSONValue
        }
    }
    ...
    public struct GetInputDefaultSettings: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var defaultInputSettings: JSONValue
        }
    }
    ...
    public struct GetInputVolume: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var inputVolumeMul: Int

            /// Volume setting in dB
            var inputVolumeDb: Int
        }
    }
    ...
    public struct GetInputAudioTracks: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var inputAudioTracks: JSONValue
        }
    }
    ...
    public struct TriggerMediaInputAction: OBSRequest {
        ...
        var mediaAction: OBSEnums.MediaInputAction
    }
    ...
    public struct GetRecordStatus: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var ouputPaused: Bool

            /// Current formatted timecode string for the output
            var outputTimecode: String
    ...
    /// - Version: Latest Supported RPC Version - `1`
    /// - Since: Added in v5.0.0
    public struct GetGroupItemList: OBSRequest {
        public typealias ResponseType = Response
    ...
    public struct DuplicateSceneItem: OBSRequest {
        ...
        var destinationSceneName: String?
    ...
    public struct GetSceneItemTransform: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var sceneItemTransform: JSONValue
        }
    }
    ...
    public struct GetSceneTransitionList: OBSRequest {
        ...
        public struct Response: OBSRequestResponse {
            ...
            var currentSceneTransitionName: String?

            /// Kind of the current scene transition. Can be `nil`
            var currentSceneTransitionKind: String?

            /// Array of transitions
            var transitions: [JSONValue]
        }
    }
    ...
    public enum AllTypes: String, Codable {
        ...
        // return OBSRequests.BroadcastCustomEvent<E: OBSEvent>.ResponseType.self
            ...
            case .GetGroupItemList:
                return try data.toCodable(OBSRequests.GetGroupItemList.ResponseType.self)
            case .GetSceneItemId:
...
public enum OBSEvents {
    ...
    public struct InputCreated: OBSEvent {
        ...
        var unversionedInputKind: String
