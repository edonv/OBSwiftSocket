...
extension InputSettings {
    public enum TextSource {
        ...
        public struct FreeType2: InputSettingsProtocol {
            ...
            // 1 -> 1000, by 1
            /// - Requires: Value Restrictions - `>= 1, <= 1000`
            /// - Note: Default setting
            ...
            // 10, // 0 -> 4096, by 1
            /// - Requires: Value Restrictions - `>= 0, <= 4096`
        ...
        public struct GDIPlus: InputSettingsProtocol {
            ...
            // TODO: Is this 0-100 or 0.0 to 1.0? Same as others?
            // 0
            ...
            /// This is used as the property to interface with, as it can inlcude the opacity value together.
            ...
            // TODO: Some sort of thing as an angle? In degrees?
            // 90.0
            /// - Note: Default setting
    ...
    public struct Font: Codable {
        ...
        // 0, // what is the use of this? maybe on pc?
        /// What is the use? Is it a bitwise thing?
        public var flags: Int
        
        /// What is the scale? Point size?
        // 256,
        public var size: Int
